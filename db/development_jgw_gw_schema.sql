...
--
-- Temporary table structure for view `enquete_view_questions`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `enquete_view_questions` (
...
--
-- Table structure for table `gw_schedule_user_move_logs`
--

DROP TABLE IF EXISTS `gw_schedule_user_move_logs`;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
CREATE TABLE `gw_schedule_user_move_logs` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `schedule_id` int(11) DEFAULT NULL,
  `state` varchar(255) DEFAULT NULL COMMENT 'copy or delete',
  `uid` int(11) DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `created_uid` text COMMENT '実行者',
  `created_gid` text,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
SET character_set_client = @saved_cs_client;
...
/*!50001 DROP TABLE `enquete_view_questions`*/;
/*!50001 DROP VIEW IF EXISTS `enquete_view_questions`*/;
...
-- Dump completed on 2011-05-23  4:04:29
