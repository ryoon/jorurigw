class Gwsub::Public::Sb01::Sb01TrainingPlansController < ApplicationController
...
#    item.creator
  ...
  def create_kari_id()
    ...
    return set_kari_id(2000000000 + rand(147483647))
  end
  ...
  def destroy
    ...
    after_process = Proc.new{
        ...
        #Gwsub::Sb01TrainingSchedule.destroy_all("training_id = #{@item.id}")
        #Gwsub::Sb01TrainingScheduleMember.destroy_all("training_id = #{@item.id}")
      }
    options = {
      :success_redirect_uri=>location,
