class Gwsub::Public::Sb04::Sb04SeatingListsController < ApplicationController
  ...
  def search_condition
    ...
    qsa = ['limit', 's_keyword' ,'fyed_id','grped_id','v' ]
  ...
  def create_bbs_docs
    ...
    if @title.dbname.blank?
      ...
      truncate_query6 = "TRUNCATE TABLE gwbbs_images ;"
      connect.execute(truncate_query6)
      truncate_query7 = "TRUNCATE TABLE gwbbs_recognizers ;"
      connect.execute(truncate_query7)
    end
    default_published = 240 unless default_published  #とりあえず24ヶ月
    groups.each do |g|
