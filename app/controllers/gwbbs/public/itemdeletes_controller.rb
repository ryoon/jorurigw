class Gwbbs::Public::ItemdeletesController < ApplicationController
  ...
  def edit
    ...
    item.and :admin_code, Site.user.code
  ...
  def create_target_record
    Gwbbs::Itemdelete.delete_all(["content_id = 2 AND admin_code = '#{Site.user.code}'"])
