...
#フォーム情報
################################################################################
class Questionnaire::Public::Templates::PreviewsController < ApplicationController
  ...
  def initialize_scaffold
    ...
    @field_lists = ''
    @field_lists = JsonParser.new.parse(@title.form_body) unless @title.form_body.blank?
