class Gwworkflow::Admin::Menus::CommissionsController < Gw::Controller::Admin::Base
  ...
  def list
    ...
    s_redirect = "/gwworkflow#{params[:parent_id]}/commissions" if params[:redirect_url].blank?
