class Gwqa::Public::DocsController < ApplicationController
  ...
  def initialize_scaffold
    ...
    return redirect_to("#{Site.current_node.public_uri}?title_id=#{@title.id}#{str_param}") if params[:reset]
  ...
  def update
    ...
    _update_plus_location @item, @item.docs_path
  end
  ...
  def destroy
    ...
    local = "#{@item.docs_path}#{str_param}"
  ...
  def settlement
    ...
    redirect_to "#{@item.docs_path}#{str_param}"
  end
