class Digitallibrary::Public::DocsController < ApplicationController
  ...
  def update
    ...
    next_location = "#{@item.docs_path}&state=#{params[:state]}"
  ...
  def destroy
    ...
    redirect_to "#{@item.item_path}#{str_param}"
  end
