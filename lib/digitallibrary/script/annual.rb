...
class Digitallibrary::Script::Annual
  ...
  def self.renew_adms
    ...
    for adm in adms
      ...
      Digitallibrary::Adm.update_all(update_fields, sql_where)
  ...
  def self.renew_admingrps_json
    ...
    for title in titles
      ...
      if is_update
        ...
        Digitallibrary::Control.update_all(update_field, "id=#{title.id}")
  ...
  def self.renew_roles
    ...
    for role in roles
      ...
      Digitallibrary::Role.update_all(update_fields, sql_where)
