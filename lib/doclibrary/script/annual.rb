...
class Doclibrary::Script::Annual
  ...
  def self.renew_adms
    ...
    for adm in adms
      ...
      Doclibrary::Adm.update_all(update_fields, sql_where)
  ...
  def self.renew_roles
    ...
    for role in roles
      ...
      Doclibrary::Role.update_all(update_fields, sql_where)
  ...
  def self.renew_folder_acls
    ...
    for @title in items
      ...
      for acl in acls
        ...
        Doclibrary::FolderAcl.update_all(update_fields, sql_where)
      ...
      for acl in acls
        unless acl.folder_id == break_folder_id
          if is_update
            ...
            folder.update_all(update_field, "id=#{break_folder_id}")
